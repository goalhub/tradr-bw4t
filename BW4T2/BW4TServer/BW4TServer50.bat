...
java -cp "BW4TServer.jar;%RepastCore%\lib\*;%RepastRuntime%\lib\*;%RepastRuntime%\bin;%RepastBinSrc%\repast.simphony.bin_and_src.jar" nl.tudelft.bw4t.server.BW4TEnvironment -scenario ./BW4T.rs -map Random -serverip localhost -serverport 8000 -delay 50
